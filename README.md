# Windows Dotfiles
<img align="right" src="./src/Screens v2.png" alt="Rice Preview" width="363px"/>
<ul>
    <li>Terminal Apps</li>
    <ul>
        ...
        <li><a href="https://github.com/sxyazi/yazi">yazi</a></li>
        <li><a href="https://github.com/ffmpeg/ffmpeg">FFmpeg</a></li>
        <li><a href="https://github.com/charmbracelet/glow">glow</a></li>
        <li><a href="https://github.com/fasouto/termaid">Termaid</a></li>
        <li><a href="https://github.com/maaslalani/sheets">sheets</a></li>
        <li><a href="https://github.com/aristocratos/btop">btop</a></li>
        <li><a href="https://github.com/ip7z/7zip">7zip</a></li>
...
> [!NOTE]
> I'm using Neovim v0.11.5 not the latest version
...
<ul>
    ...
    <ul>
        ...
        <li><a href="https://github.com/nvim-mini/mini.indentscope">mini.indentscope</a></li>
        <li><a href="https://github.com/nvzone/showkeys">showkeys</a></li>
        <li><a href="https://github.com/nvim-mini/mini.cursorword">mini.cursorword</a></li>
    </ul>
    <li>Navigation</li>
    <ul>
        ...
        <li><a href="https://github.com/rafi/telescope-thesaurus.nvim">telescope-thesaurus.nvim</a></li>
        <li><a href="https://github.com/hedyhli/outline.nvim">outline.nvim</a></li>
        <li><a href="https://github.com/2KAbhishek/nerdy.nvim">nerdy.nvim</a></li>
        <li><a href="https://github.com/folke/flash.nvim">flash.nvim</a></li>
    </ul>
    <li>Functional</li>
    <ul>
        ...
        <li><a href="https://github.com/nvim-treesitter/nvim-treesitter-textobjects">nvim-treesiter-textobjects</a></li>
        <li><a href="https://github.com/nvim-mini/mini.surround">mini.surround</a></li>
